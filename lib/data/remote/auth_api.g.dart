...
class _AuthApi implements AuthApi {
  ...
  Future<BaseResponse<UserData?>> signIn(LoginRequestModel request) async {
    ...
    final _options = _setStreamType<BaseResponse<UserData>>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<BaseResponse<GetCartData?>> getCartData() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<BaseResponse<GetCartData>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late BaseResponse<GetCartData?> _value;
    try {
      _value = BaseResponse<GetCartData?>.fromJson(
        _result.data!,
        (json) => json == null
            ? null
            : GetCartData.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
  ...
  Future<GetQuotesResponse?> getQuotesData(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetQuotesResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>?>(_options);
    late GetQuotesResponse? _value;
    try {
      _value = _result.data == null
          ? null
          : GetQuotesResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<GetTodosResponse?> getTodosData() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GetTodosResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>?>(_options);
    late GetTodosResponse? _value;
    try {
      _value = _result.data == null
          ? null
          : GetTodosResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
